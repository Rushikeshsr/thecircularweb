  ...
  return (
    <>
        ...
        <div className='section2 p-5'>
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Medicine Drives for Senior Citizens: Ensuring Access to Vital Medications</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Comprehensive Healthcare Support: Nurturing Holistic Well-being</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Promoting Awareness and Education: Empowering Senior Citizens</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Fostering Interactions and Support: Building Community Connections</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Operations and Processes: Making a Difference Together</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Identification and Assessment:</span><br/> 
                Our partnership with the CareGood Foundation goes beyond medicine drives. We recognize that healthcare encompasses a wide range of needs for senior citizens. Thus, we work hand in hand to provide comprehensive healthcare support, including regular health check-ups, access to medical specialists, and assistance with navigating complex healthcare systems. By offering a holistic approach to senior care, we empower older adults to lead healthier, more fulfilling lives.
            </p>
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Medicine Collection:</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Distribution and Outreach:</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Healthcare Support and Education:</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Community Engagement:</span><br/> 
            ...
            <p className='paragh'>
                <span style={{"color":"#00ff0d",fontSize:'20px',textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Join Our Mission: Together, Let's Empower Senior Citizens</span><br/> 
                <span style={{color:"#00ff0d"}}>The Circular</span> and the CareGood Foundation invite you to join us in our mission to empower senior citizens through medicine drives and comprehensive healthcare initiatives. Your support can make a significant difference in the lives of older adults, ensuring they receive the care, dignity, and support they deserve. Whether you choose to contribute financially, volunteer your time, or spread awareness about our partnership and initiatives, your involvement is invaluable.
            </p>
