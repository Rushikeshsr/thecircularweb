  ...
  return (
    <>
        ...
        <div className='section2'>
            ...
            <p className='paragh'>
                <span className='font-head' style={{"color":"#00ff0d",fontSize:'20px'}} >Medicine Drives for Senior Citizens : Ensuring Access to Vital Medications</span><br/> 
            ...
            <p className='paragh'>
                <span className='font-head' style={{"color":"#00ff0d",fontSize:'20px'}} >Comprehensive Healthcare Support : Nurturing Holistic Well-being</span><br/> 
            ...
            <p className='paragh'>
                <span className='font-head' style={{"color":"#00ff0d",fontSize:'20px'}} >Promoting Awareness and Education : Empowering Senior Citizens</span><br/> 
            ...
            <p className='paragh'>
                <span className='font-head' style={{"color":"#00ff0d",fontSize:'20px'}} >Fostering Interactions and Support : Building Community Connections</span><br/> 
            ...
            <p className='paragh'>
                <span className='font-head' style={{"color":"#00ff0d",fontSize:'20px'}} >Operations and Processes: Making a Difference Together</span><br/> 
        ...
        <div className='section3'>
            ...
            <p className='para'>
                <HashLink  smooth to="/contactus/#joinus" className='font-head' style={{fontSize:'20px', textDecoration:"none", "color":"#00ff0d",textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}} >Join Our Mission : Together, Let's Empower Senior Citizens</HashLink><br/> 
