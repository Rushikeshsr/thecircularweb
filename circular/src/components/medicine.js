  ...
  return (
    <>
        ...
        <div className='section2'>
            ...
            <p className='paragh'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d"}}>Collaboration for Seamless Healthcare</span><br/>
            ...
            <p className='paragh'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d"}}>Navigating Challenges During the Pandemic</span><br/>
            ...
            <p className='paragh'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d"}}>Innovative Models for Accessibility</span><br/>
            ...
            <p className='paragh'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d"}}>Proud to Serve the Communities</span><br/>
        ...
        <div className='section3'>    
            <div className="image-container mb-4">
                <div className='d-flex flex-column'>
                    <img data-aos="fade-up" data-aos-delay="100" className='medpich m-2' src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685849380/Circular%20website/med1_lpovmx.jpg"} alt="cir1"/>
                    <img data-aos="fade-down" data-aos-delay="100" className='medpich m-2' src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685849381/Circular%20website/med3_bg0w4g.jpg"} alt="cir3"/>
                </div>
                <img data-aos="fade-down" data-aos-delay="100" className='medpicv' src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685849381/Circular%20website/med2_rm51ii.jpg"} alt="cir2"/>
            </div>
        </div>
    </>
  )
