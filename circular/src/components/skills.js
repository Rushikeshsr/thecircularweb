    ...
    <>
        ...
        <div className='section3'>
            <div className='text-center m-3'>
                <img className='skills-pic' style={{height:"420px",width:"350px",padding:"5px", borderRadius:"15px"}} src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685877410/Circular%20website/skills/sk1_jerwgh.jpg"} alt='cloudinery sk1'></img>
                <img className='skills-pic' style={{height:"420px",width:"350px",padding:"5px", borderRadius:"15px"}} src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685877404/Circular%20website/skills/sk2_tdi7fj.jpg"} alt='cloudinery sk2'></img>
                <img className='skills-pic' style={{height:"420px",width:"350px",padding:"5px", borderRadius:"15px"}} src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685877404/Circular%20website/skills/sk3_u9n9gm.jpg"} alt='cloudinery sk3'></img>
                <img className='skills-pic' style={{height:"420px",width:"350px",padding:"5px", borderRadius:"15px"}} src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685877404/Circular%20website/skills/sk4_drjch7.jpg"} alt='cloudinery sk4'></img>
                <img className='skills-pic' style={{height:"420px",width:"350px",padding:"5px", borderRadius:"15px"}} src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685877404/Circular%20website/skills/sk5_fw2kyi.jpg"} alt='cloudinery sk5'></img>
                <img className='skills-pic' style={{height:"420px",width:"350px",padding:"5px", borderRadius:"15px"}} src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685877404/Circular%20website/skills/sk6_lucgvu.jpg"} alt='cloudinery sk6'></img>
            </div>
            <div className='text-center m-2'>
                <video className='field-video' width="400px" height="500px" muted controls>
        ...
        <div className='section4'>
            <div id="neelmani" name="neelmani" className='m-4 d-flex justify-content-center'>
                <div data-aos="zoom-in"  className='cardbox d-flex' style={{height:"410px",boxShadow:"2px 2px 10px black"}}>
                    <img className='image-card neelmani' style={{height:"410px"}} src={"https://res.cloudinary.com/dh4bpcja3/image/upload/v1685849368/Circular%20website/1story_lab5zp.jpg"} alt="Neelmani"/>
            ...
            <div id="jamuna" name="jamuna" className='m-4 d-flex justify-content-center'>    
