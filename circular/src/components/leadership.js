    ...
    <>
        ...
        <div className='section4'>
            ...
            <div className='profile'>
                ...
                <div>
                    {showJR?
                    <p data-aos="fade-down" className='image-para'>Mr. Shankar Jamparathi began his journey in the world of astronomy after completing his BSc in MPE (Mathematics, Physics, and Electronics) from City College Hyderabad in 1983. In 1987, he was appointed as a Scientific Assistant at the Japal-Rangapur Observatory, and his physics background provided him with a solid foundation to excel in his role. Over the years, he has demonstrated exceptional proficiency in working with various instruments, including photometry, spectrographs, and CCD (Charge-Coupled Device) programs on the 48-inch Telescope. Since 1990, Shankar Jamparathi has taken on the responsibility of In Charge at the observatory, showcasing his leadership skills and ability to oversee and coordinate operations effectively. His expertise extends beyond the astronomical instruments, as he also handles the maintenance of the telescope, electrical instruments, a 100 kVA transformer, different types of UPS (Uninterruptible Power Supply), and computer systems. Furthermore, he diligently manages the office works at the Japal-Rangapur Observatory, ensuring the smooth functioning of administrative tasks.<br/><br/>
                            With his extensive knowledge and experience, Shankar Jamparathi has become a trusted authority in his field. He is known for his expertise in the operation and maintenance of advanced astronomical instruments, which are vital for conducting precise observations and research. His meticulous attention to detail and technical proficiency ensure that the telescope and other equipment are maintained to the highest standards, enabling the observatory to produce accurate and valuable scientific data. Beyond his technical responsibilities, Shankar Jamparathi is deeply passionate about sharing his knowledge and fostering an interest in astronomy among students and the wider community. He has actively participated in numerous outreach programs and educational initiatives, where his engaging presentations and insightful explanations have captivated audiences of all ages. His dedication to promoting the wonders of the universe has made him a respected figure in the field of astronomy, and he continues to inspire budding astronomers and scientists. Through his decades of experience and unwavering commitment, Shankar Jamparathi has solidified his position as an invaluable asset to our organization. His profound understanding of astronomy, remarkable technical skills, and diligent maintenance of the observatory's equipment contribute to our ongoing pursuit of scientific discovery and exploration.<br/><br/>
                    </p>:null}
                </div>
            </div>
        </div>
