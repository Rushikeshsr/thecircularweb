...
import { rukhminiGallery } from './rukhminiGallery';
  ...
  return (
    <>
      ...
      <div className='section4'>
        ...
        <p data-aos="flip-left" data-aos-delay="100" className='together para text-center' style={{ fontSize: "20px", fontWeight: "bold" }}>
        ...
        <div className='para text-center mb-5'>
          <div className="image-gallery-wrapper">
            <ImageGallery autoPlay={true} showThumbnails={false} items={rukhminiGallery} />
            <HashLink style={{ textDecoration: "none"}} smooth to="/aboutus/leadership#rukhmini">
            <p className='mt-3'> 
            Recently on the occasion of World's Environment Day 2023, Our Dr. J. Rukmini's article got published in the largest circulated Telugu Science Magazine.
            </p>
            </HashLink>
          </div>
        </div>
