...
const Nature = () => {
  return (
    <>
        ...
        <div className='p-5'>
            <h1 className='main-heading'>We are working against time to reach our milestones</h1><br/>
            <div className='paragh text-center'>
                <video width="700px" height="400px" autoPlay={true} controls>
        ...
        <div id="story7" name="story7" className='section2 d-flex justify-content-center p-5'>
            <div data-aos="zoom-in"  className='cardbox d-flex' style={{boxShadow:"2px 2px 10px aliceblue"}}>
