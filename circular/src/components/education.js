...
const Education = () => {
  ...
  return (
    <>
        ...
        <div id="ripal" name="ripal" className='section3 p-5'>
            <div className='image-text'>
                <div className='col-6 box-image'>
                    <img data-aos="flip-left" className='person' src="https://res.cloudinary.com/dh4bpcja3/image/upload/v1685849389/Circular%20website/ripal_h77oin.jpg" alt="ripal"/>
                    <p>Ripal Desai</p>
                </div>
            ...
            <div className='col-12 image-text'>
                ...
                <div data-aos="fade-down" className='d-flex mb-4' style={{justifyContent:"space-around"}}>
