  ...
  return (
    <>
        ...
        <div className='section3'>
            <p className='para'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d",textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}}>Transparency in Fostering Quality Human Capital</span><br/>
            ...
            <p data-aos="fade-right" data-aos-delay="200" className='para'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d",textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}}>Promoting Ethical Corporate Governance</span><br/>
            ...
            <p data-aos="fade-left" data-aos-delay="200" className='para'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d",textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}}>Curbing Student Exploitation</span><br/>
            ...
            <p data-aos="fade-right" data-aos-delay="200" className='para'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d",textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}}>Early Interventions for Quality Human Capital</span><br/>
            ...
            <p data-aos="fade-left" data-aos-delay="200" className='para'>
                <span className='font-head' style={{fontSize:"20px",color:"#00ff0d",textShadow:"-0.5px 0.5px 0 #000, 0.5px 0.5px 0 #000, 0.5px -0.5px 0 #000, -0.5px -0.5px 0 #000"}}>Measuring Impact and Driving Future Growth</span><br/>
